      ...
      <div className="p-6 md:p-8 flex flex-col gap-4 flex-1 justify-between">
        ...
        <div className="flex justify-between items-center pt-2">
          ...
          <button
            ...
            onClick={(e) => {
              e.stopPropagation();
              navigate(`/explore/${pkg?.id}`);
            }}
            className="bg-black text-white text-xs font-medium uppercase tracking-wider px-6 py-2.5 rounded-full hover:bg-slate-800 transition-colors shadow-sm cursor-pointer"
          >
            View Trip
          </button>
        </div>
